...
class BotLogging:
    ...
    def __init__(self, logger_name: str, logs_dir: str, bot_token: str, admin, 
    ...
    def get_bot_logger(self):
        ...
        with open(self.config_file, "r") as f:
            ...
            if not dict_config["handlers"]["telegram"]: return None
            ...
            dict_config["handlers"]["telegram"]["class"] = self.get_handler_dir('.telegram_errors_handler.TelegramHandler')
    ...
    def get_logger(self):
        ...
        if not logger: logger, status = self.get_default_logger(), 'Default'
